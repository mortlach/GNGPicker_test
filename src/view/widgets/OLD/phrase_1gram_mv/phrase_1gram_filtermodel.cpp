...
Phrase1GramsilterModel::Phrase1GramsilterModel(QObject* parent) :
    GNGFilterModel(parent)
  , chosen_column(0)
{}
bool Phrase1GramsilterModel::filterAcceptsRow(int source_row,const QModelIndex &source_parent) const{
